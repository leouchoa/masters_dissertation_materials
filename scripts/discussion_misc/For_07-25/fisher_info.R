get_fisher_info <- function(theta_vec,nus,coords_matrix){
  ...
  B_11_sigma1 = C_11_st %*% M_1 +   0.5 * rho * sqrt( sigmas[2]/(sigmas[1]) )* C_12_st %*% M_3
  
  B_21_sigma1 = t(C_12_st) %*% M_1 +  0.5 * rho * sqrt( sigmas[2]/(sigmas[1]) ) * C_22_st %*% M_3
  
  B_12_sigma1 = 0.5 * rho * sqrt( sigmas[2]/(sigmas[1]) ) * C_11_st %*% M_3
  
  B_22_sigma1 = rho * sqrt( sigmas[2]/(sigmas[1]) ) * t(C_12_st) %*% M_3
  ...
  B_11_sigma2 = 0.5 * rho * sqrt( sigmas[1]/(sigmas[2]) ) * C_12_st %*% M_3
  
  B_21_sigma2 = 0.5 * rho * sqrt( sigmas[1]/(sigmas[2]) ) * C_22_st %*% M_3
  
  B_12_sigma2 = 0.5 * rho * sqrt( sigmas[1]/(sigmas[2]) ) * C_11_st %*% M_3 + C_12_st %*% M_2
  
  B_22_sigma2 = 0.5 * rho * sqrt( sigmas[1]/(sigmas[2]) ) * t(C_12_st) %*% M_3 + C_22_st %*% M_2
