...
plot_llike_contour_ggplot <- function(var_1,var_2,grid_df,obs, coords,true_param = NULL,nbins = 30,gamma_plot = 1){
  ...
  ggplot(grid_df,
         aes_string(var_1, var_2, z = eval_llike_results)
         ) + 
...
# plot_llike_contour_field("a","rho",grid_df = grid_02,obs = log_cd, coords = coords,true_theta = true_theta)
# 
# 
# plot_llike_contour_field_fisher("a","rho",grid_df = grid_02,obs = log_cd, coords = coords,true_theta = true_theta)
# 
...
#   0.2)
# 
# plot_llike_contour_field("sigma2_1","a",grid_df = grid_01,obs = log_cd, coords = coords,true_theta = true_theta)
# 
...
#   0.5)
# 
# plot_llike_contour_field("sigma2_1","sigma2_2",grid_df = grid_03,obs = log_cd, coords = coords,true_theta = true_theta)
# 
...
# 
# plot_llike_contour_field("sigma2_1","rho",grid_df = grid_04,obs = log_cd,gamma_plot = 0.0005, coords = coords,true_theta = true_theta)
